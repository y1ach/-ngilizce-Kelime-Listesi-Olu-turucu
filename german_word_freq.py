...
def fetch_german_wikipedia_articles(keywords, num_articles=7):
    user_agent = "YourCustomUserAgent/1.0 (yigitalicelik@hotmail.com)"  # Kendi User-Agent'ini buraya yaz
...
keywords = ["America", "United States", "England", "Technology", "History", "Culture", "Science"]
...
analyze_word_frequency(german_text, "top_10000_words_en.txt")
